...
# installed.
TCL_PREFIX='/scikit-learn/entorno'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/scikit-learn/entorno'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe -isystem /scikit-learn/entorno/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1695505963869/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/scikit-learn/entorno=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /scikit-learn/entorno/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--allow-shlib-undefined -Wl,-rpath,/scikit-learn/entorno/lib -Wl,-rpath-link,/scikit-learn/entorno/lib -L/scikit-learn/entorno/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/scikit-learn/entorno/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/scikit-learn/entorno/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/scikit-learn/entorno/include'
...
# compiled.
TCL_SRC_DIR='/scikit-learn/entorno/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/scikit-learn/entorno/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/scikit-learn/entorno/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/scikit-learn/entorno/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/scikit-learn/entorno/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/scikit-learn/entorno/lib/libtclstub8.6.a'
