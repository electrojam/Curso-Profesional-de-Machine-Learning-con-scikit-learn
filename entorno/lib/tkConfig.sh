...
# build directory.
TK_BUILD_LIB_SPEC='-L/scikit-learn/entorno/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/scikit-learn/entorno/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/scikit-learn/entorno/include'
...
# compiled.
TK_SRC_DIR='/scikit-learn/entorno/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/scikit-learn/entorno/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/scikit-learn/entorno/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/scikit-learn/entorno/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/scikit-learn/entorno/lib/libtkstub8.6.a'
